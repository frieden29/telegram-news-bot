...
# حماية من إغراق القناة في تشغيل واحد
...
# =========================================================
# كلمات لا تفيد كثيراً في مقارنة الخبر
# =========================================================
...
def contains_arabic_syria_keyword(text):
...
def contains_english_syria_keyword(text):
...
def is_syria_news(text):
    ...
    return (
        contains_arabic_syria_keyword(text)
        or contains_english_syria_keyword(text)
    )
...
def event_similarity(title1, title2):
    ...
    # لا نعتبر حدثاً واحداً بسبب كلمة أو كلمتين فقط
    if len(shared) < 3:
        return 0
...
# =========================================================
# جلب عدة أخبار من المصدر المباشر
# =========================================================
...
def get_rss_candidates(
    ...
    for item in soup.find_all(
        ...
        # حماية مهمة:
        # النتيجة نفسها يجب أن تذكر سوريا
        if not is_syria_news(
            original_title
        ):
            continue
